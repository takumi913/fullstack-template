...
export function RelatedResources({ tool }: { tool: ToolPageDefinition }) {
  ...
  return (
    <section className="border-t pt-12">
      <h2 className="text-2xl font-semibold tracking-[-0.03em] text-zinc-950">Related resources</h2>
      <div className="mt-6 grid gap-3 sm:grid-cols-2">
        {resources.map((resource) => (
          <Link
            ...
            to={resource.path}
          >
            <p className="text-xs capitalize text-zinc-500">{resource.kind.replace("-", " ")}</p>
